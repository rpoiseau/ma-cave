...
export const APPELLATION_PROFILES: AppellationProfile[] = [
  ...
  { id: 'chatillon-en-diois', name: 'Châtillon-en-Diois', country: 'France', region: 'Rhône', color: WineColor.Red, minYears: 2, maxYears: 5 },
  ...
  { id: 'duche-d-uzes', name: 'Duché d\'Uzès', country: 'France', region: 'Rhône Sud', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'pierrevert', name: 'Pierrevert', country: 'France', region: 'Provence', color: WineColor.Rose, minYears: 1, maxYears: 3 },
  { id: 'coteaux-d-aix-en-provence', name: 'Coteaux d\'Aix-en-Provence', country: 'France', region: 'Provence', color: WineColor.Rose, minYears: 1, maxYears: 3 },
  ...
  { id: 'montravel', name: 'Montravel', country: 'France', region: 'Sud-Ouest', color: WineColor.White, minYears: 2, maxYears: 6 },
  ...
  { id: 'coteaux-du-vendomois', name: 'Coteaux du Vendômois', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 2, maxYears: 5 },
  { id: 'orleans', name: 'Orléans', country: 'France', region: 'Loire', color: WineColor.White, minYears: 2, maxYears: 5 },
  { id: 'orleans-clery', name: 'Orléans-Cléry', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'coteaux-du-giennois', name: 'Coteaux du Giennois', country: 'France', region: 'Loire', color: WineColor.White, minYears: 2, maxYears: 5 },
  { id: 'coteaux-du-loir', name: 'Coteaux du Loir', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 3, maxYears: 8 },
  { id: 'pouilly-sur-loire', name: 'Pouilly-sur-Loire', country: 'France', region: 'Loire', color: WineColor.White, minYears: 1, maxYears: 3 },
  { id: 'valencay', name: 'Valençay', country: 'France', region: 'Loire', color: WineColor.White, minYears: 2, maxYears: 5 },
  { id: 'cheverny', name: 'Cheverny', country: 'France', region: 'Loire', color: WineColor.White, minYears: 2, maxYears: 5 },
  ...
  { id: 'haut-poitou', name: 'Haut-Poitou', country: 'France', region: 'Loire', color: WineColor.White, minYears: 1, maxYears: 4 },
  ...
  { id: 'fiefs-vendeens', name: 'Fiefs Vendéens', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 1, maxYears: 4 },
  ...
  { id: 'coteaux-d-ancenis', name: 'Coteaux d\'Ancenis', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 1, maxYears: 4 },
  ...
  { id: 'cotes-d-auvergne', name: 'Côtes d\'Auvergne', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 2, maxYears: 5 },
  { id: 'saint-pourcain', name: 'Saint-Pourçain', country: 'France', region: 'Loire', color: WineColor.Red, minYears: 2, maxYears: 5 },
  { id: 'floc-de-gascogne', name: 'Floc de Gascogne', country: 'France', region: 'Sud-Ouest', color: WineColor.Sweet, minYears: 1, maxYears: 3 },
  { id: 'tursan', name: 'Tursan', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'bearn', name: 'Béarn', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'entraygues-le-fel', name: 'Entraygues - Le Fel', country: 'France', region: 'Sud-Ouest', color: WineColor.White, minYears: 2, maxYears: 5 },
  { id: 'estaing', name: 'Estaing', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 5 },
  { id: 'saint-sardos', name: 'Saint-Sardos', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'cotes-de-millau', name: 'Côtes de Millau', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 5 },
  ...
  { id: 'brulhois', name: 'Brulhois', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 2, maxYears: 6 },
  { id: 'coteaux-du-quercy', name: 'Coteaux du Quercy', country: 'France', region: 'Sud-Ouest', color: WineColor.Red, minYears: 3, maxYears: 8 },
  { id: 'moselle', name: 'Moselle', country: 'France', region: 'Lorraine', color: WineColor.White, minYears: 1, maxYears: 4 },
  { id: 'cotes-de-toul', name: 'Côtes de Toul', country: 'France', region: 'Lorraine', color: WineColor.Rose, minYears: 1, maxYears: 3 },
  { id: 'bugey', name: 'Bugey', country: 'France', region: 'Bugey', color: WineColor.Sparkling, minYears: 1, maxYears: 4 },
...
const APPELLATION_ENRICHMENT: Record<string, Partial<AppellationProfile>> = {
  ...
  'chatillon-en-diois': { grapes: ['Gamay', 'Pinot Noir'], style: 'Rouge alpin léger du Diois', investmentPotential: 'low' },
  ...
  'duche-d-uzes': { grapes: ['Grenache', 'Syrah'], style: 'Rouge méridional du Gard', investmentPotential: 'low' },
  ...
  'coteaux-d-aix-en-provence': { grapes: ['Grenache', 'Syrah', 'Cinsault', 'Cabernet Sauvignon'], style: 'Rosé provençal frais et fruité', investmentPotential: 'low' },
  ...
  'montravel': { grapes: ['Sauvignon Blanc', 'Sémillon', 'Muscadelle'], style: 'Blanc sec du Bergeracois', investmentPotential: 'low' },
  ...
  'coteaux-du-vendomois': { grapes: ['Pineau d\'Aunis'], style: 'Rouge poivré du Loir-et-Cher', investmentPotential: 'low' },
  'orleans': { grapes: ['Chardonnay', 'Pinot Meunier'], style: 'Vin léger des bords de Loire', investmentPotential: 'low' },
  'orleans-clery': { grapes: ['Cabernet Franc'], style: 'Rouge confidentiel du Loiret', investmentPotential: 'low' },
  'coteaux-du-giennois': { grapes: ['Sauvignon Blanc', 'Gamay'], style: 'Blanc vif voisin de Pouilly-Fumé', investmentPotential: 'low' },
  'coteaux-du-loir': { grapes: ['Pineau d\'Aunis', 'Chenin Blanc'], style: 'Rouge/blanc du Loir', investmentPotential: 'low' },
  'pouilly-sur-loire': { grapes: ['Chasselas'], style: 'Blanc léger de Chasselas', investmentPotential: 'low' },
  'valencay': { grapes: ['Sauvignon Blanc', 'Gamay'], style: 'Blanc/rouge du Berry', investmentPotential: 'low' },
  'cheverny': { grapes: ['Sauvignon Blanc', 'Chardonnay', 'Gamay', 'Pinot Noir'], style: 'Blanc et rouge frais du Blésois', investmentPotential: 'low' },
  ...
  'haut-poitou': { grapes: ['Sauvignon Blanc'], style: 'Blanc vif du Poitou', investmentPotential: 'low' },
  ...
  'fiefs-vendeens': { grapes: ['Pinot Noir', 'Gamay', 'Cabernet Franc'], style: 'Rouges et blancs côtiers de Vendée', investmentPotential: 'low' },
  ...
  'coteaux-d-ancenis': { grapes: ['Gamay'], style: 'Rouges et blancs du pays nantais', investmentPotential: 'low' },
  ...
  'cotes-d-auvergne': { grapes: ['Gamay', 'Pinot Noir'], style: 'Rouge volcanique d’Auvergne', investmentPotential: 'low' },
  'saint-pourcain': { grapes: ['Gamay', 'Pinot Noir'], style: 'Rouges et blancs du Bourbonnais', investmentPotential: 'low' },
  'floc-de-gascogne': { grapes: ['Colombard', 'Ugni Blanc', 'Gros Manseng'], style: 'Mistelle gasconne (jus + Armagnac)', investmentPotential: 'low' },
  'tursan': { grapes: ['Tannat', 'Cabernet Franc', 'Baroque'], style: 'Rouge et blanc des Landes', investmentPotential: 'low' },
  'bearn': { grapes: ['Tannat', 'Cabernet Franc', 'Cabernet Sauvignon'], style: 'Rouge béarnais sur Tannat', investmentPotential: 'low' },
  'entraygues-le-fel': { grapes: ['Chenin Blanc', 'Fer Servadou'], style: 'Vins de schiste de l’Aveyron', investmentPotential: 'low' },
  'estaing': { grapes: ['Fer Servadou', 'Gamay'], style: 'Petits vins de l’Aveyron', investmentPotential: 'low' },
  'saint-sardos': { grapes: ['Syrah', 'Tannat'], style: 'Rouge du Tarn-et-Garonne', investmentPotential: 'low' },
  'cotes-de-millau': { grapes: ['Gamay', 'Syrah'], style: 'Rouge des gorges du Tarn', investmentPotential: 'low' },
  'gaillac-premieres-cotes': { grapes: ['Mauzac', 'Len de l\'El'], style: 'Blanc sec de coteaux gaillacois', investmentPotential: 'low' },
  'brulhois': { grapes: ['Tannat', 'Cabernet Franc', 'Cot'], style: 'Rouge sombre du Brulhois', investmentPotential: 'low' },
  'coteaux-du-quercy': { grapes: ['Cabernet Franc', 'Cot', 'Merlot'], style: 'Rouge structuré du Quercy', investmentPotential: 'low' },
  'moselle': { grapes: ['Auxerrois', 'Pinot Gris', 'Pinot Noir'], style: 'Vins frais de la vallée de la Moselle', investmentPotential: 'low' },
  'cotes-de-toul': { grapes: ['Gamay', 'Pinot Noir', 'Auxerrois'], style: 'Gris de Toul lorrain', investmentPotential: 'low' },
  'bugey': { grapes: ['Gamay', 'Chardonnay', 'Mondeuse', 'Altesse'], style: 'Effervescents et tranquilles du Bugey', investmentPotential: 'low' },
